    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Overview of your spending & budget</p>
        </div>

        <div className="bg-white border border-gray-200 px-4 py-2 rounded-lg text-sm text-gray-700 flex items-center gap-2 font-medium shadow-xs">
      ...
      {/* Quick Add Expense Box */}
      <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm space-y-2">
        <label className="block text-xs font-semibold uppercase text-gray-500">Quick Add Expense</label>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h2 className="text-base font-bold text-gray-800 mb-4">Recent Expenses</h2>
